...
def create_professional_endpoint():
    ...
    return jsonify({'id': professional.id, 'email': professional.email, 'full_name': professional.full_name, 'service': professional.service, 'experience': professional.experience, 'document_url': professional.document_url, 'cover_photo_url': professional.cover_photo_url, 'address': professional.address, 'pincode': professional.pincode, 'status': professional.status.value, 'created_at': professional.created_at}), 201
...
def get_professional_endpoint(professional_id):
    ...
    if professional:
        return jsonify({'id': professional.id, 'email': professional.email, 'full_name': professional.full_name, 'service': professional.service, 'experience': professional.experience, 'document_url': professional.document_url, 'cover_photo_url': professional.cover_photo_url, 'address': professional.address, 'pincode': professional.pincode, 'status': professional.status.value, 'created_at': professional.created_at})
...
def get_all_professionals_endpoint():
    ...
    return jsonify([{'id': professional.id, 'email': professional.email, 'full_name': professional.full_name, 'service': professional.service, 'experience': professional.experience, 'document_url': professional.document_url, 'cover_photo_url': professional.cover_photo_url, 'address': professional.address, 'pincode': professional.pincode, 'status': professional.status.value, 'created_at': professional.created_at} for professional in professionals])

@professional_bp.route('/professionals/<int:professional_id>', methods=['PUT'])
def update_professional_endpoint(professional_id):
    data = request.get_json()
    professional = update_professional(session, professional_id, data['email'], data['password'], data['full_name'], data['service'], data['experience'], data['document_url'], data['cover_photo_url'], data['address'], data['pincode'], ProfessionalStatus[data['status'].upper()])
    if professional:
        return jsonify({'id': professional.id, 'email': professional.email, 'full_name': professional.full_name, 'service': professional.service, 'experience': professional.experience, 'document_url': professional.document_url, 'cover_photo_url': professional.cover_photo_url, 'address': professional.address, 'pincode': professional.pincode, 'status': professional.status.value, 'created_at': professional.created_at})
    return jsonify({'error': 'Professional not found'}), 404
